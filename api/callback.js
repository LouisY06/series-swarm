...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .message { color: rgba(255, 255, 255, 0.7); font-size: 1rem; line-height: 1.6; margin-bottom: 32px; }
    .card {
...
<body>
  <div class="container">
    ...
    <p class="message">Your music taste is now ready for the Lyrical Soulmates quiz.</p>
    <div class="card">
      <p class="card-title">Next Step</p>
      <p class="instruction"><span class="checkmark">✓</span>Return to chat and send <strong>/quiz</strong></p>
    </div>
  </div>
</body>
</html>`;
